...
class ArmIKNode:
    def __init__(self):
        ...
        self.node_alive_pub = rospy.Publisher('/node_alive', Bool, queue_size=1)
    ...
    def move_done_callback(self, msg):
        if msg.data and not self.grab_active:
    ...
    def execute_motion(self):
        ...
        target_pitch = -145
        target = self.AK.setPitchRanges((0.02, 0.28, -0.07), target_pitch, target_pitch, target_pitch)
        if target:
            servo_data = target[1]
            ...
            bus_servo_control.set_servos(self.joints_pub, 1000, ((1, 100), (2, 500), (3, servo_data['servo3']), (4, servo_data['servo4']), (5, servo_data['servo5']), (6, servo_data['servo6'])))
            time.sleep(1)
        ...
        bus_servo_control.set_servos(self.joints_pub, 1000, ((1, 500), (2, 500), (3, servo_value[2]), (4, servo_value[3]), (5, servo_value[4]), (6, servo_value[5])))
        time.sleep(1)
        bus_servo_control.set_servos(self.joints_pub, 1000, ((1, 250), (2, 500), (3, servo_value[2]), (4, servo_value[3]), (5, servo_value[4]), (6, servo_value[5])))
        time.sleep(2)
    ...
    def keep_alive(self):
        ...
        while not rospy.is_shutdown():
            self.node_alive_pub.publish(True)
            rate.sleep()

if __name__ == "__main__":
    arm_ik_node = ArmIKNode()
    arm_ik_node.keep_alive()
    rospy.spin()
