...
if __name__ == "__main__":
    ...
    def deactivate_ceremony():
        global ceremony_active
        ceremony_timer = False
    ...
    def ceremony_callback(msg):
        global ceremony_active, ceremony_timer
        if msg.data:
            ceremony_active = True
            # ceremony_timer = rospy.Timer(rospy.Duration(15),deactivate_ceremony,oneshot=True)
        
    ceremony_sub = rospy.Subscriber('/ceremony', Bool, ceremony_callback)
    ...
    while not rospy.is_shutdown():
        if move_finished:
        ...
        elif ceremony_active:
            
            rospy.loginfo("Ceremony !!!!")
            ...
            while not rospy.is_shutdown():
                ...
                if i == 5 : 
                    servo_data = target[1]
                    bus_servo_control.set_servos(joints_pub, 1000, ((1, 100), (2, 500), (3, servo_data['servo3']), (4, servo_data['servo4']), (5, servo_data['servo5']), (6, 500)))
                    ceremony_active = False
                    break
