...
class ArmIK:
    ...
    def transformAngelAdaptArm(self, theta3, theta4, theta5, theta6):
        ...
        print("Theta3: {}, Theta4: {}, Theta5: {}, Theta6: {}".format(theta3, theta4, theta5, theta6))
        print("(Rads) Theta3: {}, Theta4: {}, Theta5: {}, Theta6: {}".format(theta3*(np.pi/180), theta4*(np.pi/180), theta5*(np.pi/180), theta6*(np.pi/180)))
...
if __name__ == "__main__":
    ...
    #target = AK.setPitchRanges((-0.2, 0.2, 0.0), -90, -180, 0)
    ...
    #time.sleep(5)
    target = AK.setPitchRanges((0.1, 0.13, 0.08), -145, -180, 0)
    ...
    #    target = AK.setPitchRanges((-0.2 + 0.4*(step*i), 0.13, 0.08), -145, -180, 0)
...
#rostopic pub /joint4_controller/command std_msgs/Float64 "data: 0.5"
